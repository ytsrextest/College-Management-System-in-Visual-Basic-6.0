...
Begin VB.Form admintfrmLogin 
   ...
   Begin MSAdodcLib.Adodc adminado 
      ...
      Orientation     =   0
      Enabled         =   -1
      Connect         =   $"admintfrmLogin.frx":1084A
      OLEDBString     =   $"admintfrmLogin.frx":108D6
      OLEDBFile       =   ""
      DataSourceName  =   ""
      OtherAttributes =   ""
      UserName        =   ""
   ...
   Begin VB.Image Image1 
      Height          =   1066
      Left            =   117
      Picture         =   "admintfrmLogin.frx":10962
      Stretch         =   -1  'True
      Top             =   1053
      Width           =   949
   End
...
Private Sub cmdOK_Click()
    ...
    adminado.RecordSource = "select * from admin_data where username='" + admintxtUserName.Text + "' and password='" + admintxtPassword.Text + "'"
    adminado.Refresh
    LoginSucceeded = True
